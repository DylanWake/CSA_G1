...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
    public static String PROJECT_ROOT = "dependency";
    // current indicies
    /**
     * row index
     */
    ...
    private void setUpNextAndPreviousButtons() {
        ...
        Icon prevIcon = new ImageIcon(PROJECT_ROOT + "\\leftArrow.gif");
        Icon nextIcon = new ImageIcon(PROJECT_ROOT + "\\rightArrow.gif");
